...
import com.saegil.comivo.community.adapter.AnswerAdapter;
...
public class AnswerActivity extends Activity {
    ...
    static final String KEY_QUESTIONINFOLAYOUT="questionInfoLayout";
    ...
    public void init(){
        ...
        for(int i=0;i<10;i++){
            ...
            hashMap.put(KEY_QUESTIONINFOLAYOUT,"visible");
        ...
        adapter=new AnswerAdapter(this, data);
        adapter.setTitle("ANSWERS DETAILS");

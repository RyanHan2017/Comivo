...
public class AnswerAdapter extends BaseAdapter {
    ...
    public AnswerAdapter(Activity a, ArrayList<HashMap<String, String>> d) {
        activity = a;
        data=d;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null)view=inflater.inflate(R.layout.list_row_community_time_line_question,null);

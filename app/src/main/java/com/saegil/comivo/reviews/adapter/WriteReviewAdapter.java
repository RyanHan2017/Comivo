package com.saegil.comivo.reviews.adapter;
 ...
 */
public class WriteReviewAdapter extends BaseAdapter {
    ...
    public WriteReviewAdapter(Activity a, ArrayList<HashMap<String, String>> d) {
        activity = a;
        data=d;
